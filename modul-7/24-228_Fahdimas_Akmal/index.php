...
$result_semua_data = mysqli_query($koneksi, $query_semua_data);

if (!$result_semua_data) {
    die("Query Error: " . mysqli_error($koneksi) . "<br>Pastikan tabel 'pelanggan' dan kolom 'nama' sudah ada di database.");
}
?>
<!DOCTYPE html>
<html lang="id">
