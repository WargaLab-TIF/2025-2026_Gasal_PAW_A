...
<div class="container mt-4">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <h3 class="mb-0" style="color: #67b1e5;">Daftar User</h3>
        </div>
    ...
    <?php if (isset($_GET['status'])): ?>
        <p>
            <?= $_GET['status'] == 'sukses' ? "User berhasil ditambahkan" : "Gagal menambahkan user"; ?>
        </p>
    <?php endif; ?>
            ...
            <table class="table table-bordered">
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $row['username'] ?></td>
                        <td><?= $row['nama'] ?></td>
                        <td><?= $level_user[$row['level']] ?></td>
                        <td>
                            <a href="edit.php?id_user=<?= $row['id_user'] ?>" class="btn btn-warning btn-sm me-2">Edit</a>
                            <a href="hapus.php?id_user=<?= $row['id_user'] ?>" 
