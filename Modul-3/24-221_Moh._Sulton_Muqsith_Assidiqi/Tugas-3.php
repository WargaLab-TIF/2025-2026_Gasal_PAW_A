...
$height = array("Andy"=>"176", "Barry"=>"165", "Charlie"=>"170"); echo "Andy is " . $height['Andy']." cm tall.<br><br>";
...
echo "<strong>Array \$height setelah ditambah 5 data:</strong><br>"; print_r($height);
echo "<br>";
...
echo "<strong>Pesan lengkap:</strong> " . $last_key . " is " .
...
$key_to_remove = "Barry";
$removed_value = $height[$key_to_remove]; unset($height[$key_to_remove]);
echo "<strong>Data yang dihapus:</strong> " . $key_to_remove . " (" . $removed_value . " cm)<br>";
echo "<strong>Array \$height setelah dihapus 1 data:</strong><br>"; print_r($height);
echo "<br>";
...
$last_value_after . " cm tall.<br><br>";
...
echo "<strong>Array baru \$weight:</strong><br>"; print_r($weight);
echo "<br>";
...
echo "<strong>Data ke-2 dari array \$weight:</strong><br>"; echo "<strong>Kunci:</strong> " . $second_key . "<br>"; echo "<strong>Nilai:</strong> " . $second_value . " kg<br>";
echo "<strong>Pesan lengkap:</strong> " . $second_key . " weighs " .
