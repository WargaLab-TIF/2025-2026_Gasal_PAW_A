...
echo "<strong>Array \$fruits setelah ditambah 5 data:</strong><br>"; print_r($fruits);
echo "<br>";

$highest_index = count($fruits) - 1;
echo "<strong>Nilai dengan indeks tertinggi:</strong> " .
$fruits[$highest_index] . "<br>";
...
$index_to_remove = 2;
$removed_item = $fruits[$index_to_remove]; unset($fruits[$index_to_remove]);
$fruits = array_values($fruits); // Reindex array

echo "<strong>Data yang dihapus:</strong> " . $removed_item . " (indeks " . $index_to_remove . ")<br>";
echo "<strong>Array \$fruits setelah dihapus 1 data:</strong><br>"; print_r($fruits);
echo "<br>";

$highest_index_after = count($fruits) - 1;
echo "<strong>Nilai dengan indeks tertinggi setelah penghapusan:</strong> " . $fruits[$highest_index_after] . "<br>"; echo "<strong>Indeks tertinggi setelah penghapusan:</strong> " .
$highest_index_after . "<br><br>";

// Pertanyaan 3.1.3
// Membuat array baru $veggies dengan 3 data
$veggies = array("Broccoli", "Carrot", "Spinach");

echo "<strong>Array \$veggies:</strong><br>"; print_r($veggies);
echo "<br>";
